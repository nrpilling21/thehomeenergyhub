        ...
        <table className="w-full text-sm border-collapse">
          ...
          <tbody className="text-gray-600">
            <tr className="border-b border-gray-100">
              ...
              <td className="py-3 pr-4">£8,000–£10,000</td>
              <td className="py-3 pr-4">£18,000–£22,000</td>
              <td className="py-3">£500–£2,500</td>
            </tr>
            <tr className="border-b border-gray-100">
              <td className="py-3 pr-4">3-4 bed detached</td>
              <td className="py-3 pr-4">£11,000–£15,000</td>
              <td className="py-3 pr-4">£22,000–£30,000</td>
              <td className="py-3">£3,500–£7,500</td>
            </tr>
            <tr>
              <td className="py-3 pr-4">Large period property</td>
              <td className="py-3 pr-4">£14,000–£18,000</td>
              <td className="py-3 pr-4">£28,000–£35,000</td>
              <td className="py-3">£6,500–£10,500</td>
            </tr>
          </tbody>
        </table>
      </div>
