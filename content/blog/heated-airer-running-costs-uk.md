...
tags: ["heated airer", "heated clothes airer", "running costs", "energy saving", "tumble dryer", "laundry"]
---
...
## Heated airer vs tumble dryer: the real comparison

This is the comparison most people are actually looking for, and it is where the heated airer earns its keep. A tumble dryer does the same job far faster, but it draws vastly more power. The question is whether the speed is worth the cost.
...
A common mistake is to dry clothes by cranking up the radiators or draping washing over them. Running your gas central heating harder, or worse using a plug-in electric heater to dry a room, costs far more than a 300W airer. A 2kW electric heater costs around 52.6p an hour to run at the October 2026 price cap rate - more than six times a heated airer - and it heats the whole room rather than the clothes. We break the full set of figures down in our guide to [electric heater running costs](/blog/electric-heater-running-costs-uk).

Drying clothes on radiators also pushes a lot of moisture into the air, which can lead to condensation and damp on cold walls and windows. A heated airer with a cover keeps that moisture contained, and pairing it with a [dehumidifier](https://www.amazon.co.uk/s?k=dehumidifier&tag=thehomeenergyhub-21) pulls the water straight out of the air. A small dehumidifier draws only about 200W, so the combination still comes in well under the cost of heating the room, while protecting your home from damp. Our [dehumidifier running costs guide](/blog/dehumidifier-running-costs-uk) works through the full sums, including why the airer-plus-dehumidifier combination costs no more than the dehumidifier on its own. If winter condensation is a problem in your home, our guide to [how to stop condensation on windows](/blog/how-to-stop-condensation-on-windows) ranks every fix by what it costs to run, and our [draught proofing guide](/blog/draught-proofing-cost-uk) covers the other cheap fixes that keep rooms warmer and drier.

## The best heated airers in the UK for 2026

There is no single best heated airer - the right one depends on how much washing you do and where you will put it. Here is how the main types compare.

| Type | Approx. price | Best for | Notes |
|---|---|---|---|
| Flat or single-tier | £30 - £60 | Small loads, tight spaces | Lowest running cost, limited capacity |
| Winged, single-tier | £40 - £80 | Couples, flats | Wings fold out for shirts and towels |
| 3-tier deluxe | £100 - £180 | Families, big loads | Highest capacity, cover usually included |
| Heated towel rail airer | £60 - £150 | Bathrooms, permanent fixture | Higher wattage, doubles as towel warmer |

For most households a [3-tier heated airer](https://www.amazon.co.uk/s?k=heated+airer+3+tier&tag=thehomeenergyhub-21) hits the sweet spot: it holds a full load, folds flat for storage, and usually comes with a cover that keeps the running cost down. If you only wash for one or two people, a smaller [winged heated clothes airer](https://www.amazon.co.uk/s?k=winged+heated+clothes+airer&tag=thehomeenergyhub-21) is cheaper to buy and to run, and takes up far less space.

Whichever you pick, the two things that matter most for running cost are the wattage - lower is cheaper - and whether it comes with a cover. Do not pay a premium for high wattage thinking it dries faster; a covered 300W airer will out-dry an uncovered 600W one while using half the power.

## How to cut your heated airer running costs further

A few simple habits shave real money off the numbers above.

**Always use a cover.** This is the single biggest lever. Halving the drying time halves the cost, every single load. If your airer did not come with one, buy one.

**Spin your washing on a high setting first.** A fast spin cycle in the washing machine removes far more water than a slow one, so clothes arrive at the airer damper rather than soaking. Less water to evaporate means less time running.

**Space clothes out and turn them once.** Overloading the airer traps damp fabric against damp fabric. Give each item a little air and flip the thickest pieces halfway through.

**Dry in the warmest, best-ventilated room you can.** A cold, sealed room slows evaporation. A slightly warmer room with a cracked window or a dehumidifier running clears the moisture faster.

**Only run it as long as it needs.** Many airers have no timer, so it is easy to leave one running all day out of habit. A cheap plug-in timer switch turns it off automatically once the load is dry.

If you have a smart meter, watch your in-home display for the hour or two after you switch the airer on. Seeing the tiny bump in usage first-hand is reassuring, and it is the same visibility effect we describe in our guide to [whether smart meters save you money](/blog/do-smart-meters-save-you-money-uk) - once you can see how little it costs, you stop worrying about it. To model where the rest of your electricity pounds are going, our [smart meter savings calculator](/smart-meter-savings-calculator) is a good place to start.
