...
tags: ["tumble dryer", "running costs", "heat pump tumble dryer", "energy saving", "laundry", "heated airer"]
---
...
Every appliance running cost comes down to the same sum:

**Energy used (kWh) × your unit rate (p/kWh) = cost per cycle**
...
## Why heat pump tumble dryers cost so much less to run

A vented or condenser dryer works by brute force. It heats air with an electric element, blows it through the drum to pick up moisture, then throws that hot, wet air away - out of a hose in a vented model, or into a condenser unit in a condenser model. Either way the heat you paid for leaves the machine and is gone.

A heat pump dryer recycles it. It uses a refrigerant circuit - the same principle as a fridge running in reverse, or a domestic [heat pump for heating](/heat-pump-cost-uk) - to extract moisture from the air, then reheats that same air and sends it round again. Almost none of the energy escapes.

The trade-off is time. Heat pump dryers run cooler, so a full cotton cycle typically takes 2.5 to 3.5 hours against 1.5 to 2 hours for a condenser. They are gentler on fabrics as a result, but if you need a load turned round in an hour, they will frustrate you.

## Tumble dryer running costs per year
...
This is the question that matters, because heat pump dryers cost more up front. In 2026 you are looking at roughly:
...
One caveat: do not replace a working condenser dryer purely on running cost grounds. The £200 premium assumes you were buying a dryer anyway. If your current machine has years left in it, the payback calculation has to absorb the whole £400-£750, which pushes it out to four or five years.

Popular heat pump models worth comparing if you are replacing: browse current [heat pump tumble dryers](https://www.amazon.co.uk/s?k=heat+pump+tumble+dryer+9kg&tag=thehomeenergyhub-21) and check the kWh-per-cycle figure on the energy label rather than the letter rating alone - the letters were rescaled in 2021 and are less useful for comparing than the raw kWh number.

## Tumble dryer vs heated airer vs washing line

The tumble dryer is not the only option, and the cost gap between the alternatives is large.
...
The letter rating on its own is less useful than it used to be. The scale was reset in 2021, so a dryer sold as A+++ under the old scheme might be labelled B or C today without anything about the machine changing. Compare kWh figures, not letters.

## 9 ways to cut your tumble dryer running costs

**1. Spin faster before you dry.** This is the single biggest lever and it costs nothing. Increasing your washing machine's spin speed from 1,000 to 1,400 rpm removes noticeably more water, cutting dryer time by 10-15%. A 1,600 rpm spin cuts it further. The washing machine uses a few extra watts for a couple of minutes; the dryer saves several hundred watts for twenty.

**2. Dry full loads, but do not overfill.** A half-empty drum wastes the same heat on less washing. An overpacked drum stops the air circulating, so the cycle runs longer and the clothes come out damp anyway. Roughly three quarters full is the sweet spot.

**3. Use the sensor programme, not a timer.** Sensor drying stops when the clothes are dry. Timed drying runs the full duration regardless, and the last ten minutes of a timed cycle are usually pure waste. If your machine has both, the sensor setting will nearly always be cheaper.

**4. Clean the lint filter every single cycle.** A clogged filter restricts airflow, which extends cycle times by up to 30%. It takes five seconds. On condenser and heat pump models, also rinse the secondary condenser filter monthly - this is the one people forget, and a blocked one hits efficiency hard.

**5. Separate heavy items from light ones.** Towels and jeans take far longer to dry than shirts and underwear. Mixed loads mean the sensor keeps the whole cycle running until the heaviest item is dry, cooking everything else for no reason.
...
**9. Measure before you assume.** Manufacturer label figures are lab conditions on the eco programme. Your real machine on your real programme with your real loads may use considerably more. A [plug-in energy monitor](https://www.amazon.co.uk/s?k=plug+in+energy+monitor+uk&tag=thehomeenergyhub-21) costs around £15 and tells you exactly what a cycle costs, which turns all of the above from guesswork into a number.
...
Only if you are on a time-of-use tariff. On a standard single-rate tariff electricity costs the same at 3am as at 3pm. On Octopus Go or a similar off-peak tariff, night-time drying costs roughly a third as much. Never run a dryer unattended overnight, though - lint build-up remains a genuine fire risk.

### Does a full load cost more than a half load?

Slightly more in absolute terms, but far less per item. A sensor-controlled dryer runs longer with more washing in it, but the extra time is small relative to the extra volume dried, so full loads are always more efficient per garment.

## The bottom line

Tumble dryer running costs in 2026 come down almost entirely to which of three technologies is inside the machine. A condenser dryer costs around £1.25 a load and close to £200 a year. A heat pump dryer does the same work for about 40p a load and £71 a year, and the roughly £200 price premium pays back in under two years for any household drying three loads a week.
