...
tags: ["smart meter", "smart meter problems", "in-home display", "SMETS2", "energy bills"]
---
...
Before we get into the fixes, know what you are entitled to. Under the tougher Ofgem rules that came into force on 23 February 2026:

- **Response within 5 working days**: when you report a smart meter problem, your supplier must tell you in writing how it plans to resolve it within 5 working days. If they miss this window, you automatically get **£40 compensation**.
- **Repair within 90 days**: suppliers have a maximum of 90 days to repair or replace a faulty smart meter. Miss that deadline and Ofgem can take enforcement action - fines, legal action, and further consumer compensation.
- **6-week installation rule**: if you request a smart meter and have to wait more than 6 weeks for an appointment, you get £40 per affected appointment.
- **Failed installation compensation**: if the engineer turns up without the right equipment or skills and cannot complete the job, you get £40 - per failed appointment.
...
4. **Check contrast**. A few models have a contrast setting buried in the menu. If the screen looks blank but the backlight is on, turn the contrast up.
...
Another extremely common one. Usually the smart meter is not wrong - it is right, and the old meter was under-reading. Before you panic:
...
While you are investigating, a cheap plug-in [home energy monitor](https://www.amazon.co.uk/s?k=home+energy+monitor+electricity&tag=thehomeenergyhub-21) is genuinely useful for verifying consumption independently of the smart meter. We walk through how to use monitor data to cut bills in our [guide to smart meter savings](/blog/do-smart-meters-save-you-money-uk).
...
If your supplier has missed the 5-working-day response deadline, failed to repair within 90 days, or refuses to pay the automatic £40 compensation you are owed, you have the right to escalate. The process:
...
And once your meter is working correctly, you can actually start using it to cut your bills. That is what our companion guide, [Do Smart Meters Save You Money?](/blog/do-smart-meters-save-you-money-uk), gets into - where the typical 2% average saving comes from and how to push it to 10-15% with time-of-use tariffs and phantom-load hunting.
...
For households using their smart meter effectively, the savings are real. Combined with a good tariff and a bit of behaviour change, 5-15% off your annual bill is achievable. See our guide to [cavity wall insulation costs](/blog/cavity-wall-insulation-cost-uk) and [home insulation guide](/home-insulation-guide-uk) for the structural improvements that pair best with smart meter tracking.
